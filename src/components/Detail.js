            ...
            <Row>
              ...
              <Col md={5}>
                <ul className="amenities">
                  ...
                  <li><FontAwesomeIcon icon={faSink} />{house.amenities.kitchen ? "Kitchen Included" : "No Kitchen"}</li>
                  <li><FontAwesomeIcon icon={faTshirt} />{house.amenities.laundry ? "Laundry Included" : "No Laundry"}</li>
                  <li><FontAwesomeIcon icon={faFan} />{house.amenities.airconditioner ? "Air Conditioner Included" : "No Air Conditioner"}</li>
                </ul>
              </Col>
            </Row>
          </Container>
